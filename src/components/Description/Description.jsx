    ...
    return (
        <section className="description">
            ...
            <div className="description__image__container">
                <img className='description__image' src="partition.jpg" alt="Partition de musique" />
            </div>

            <div className="description__text__container">

                <p className='description__text'>Lorem Ipsum is simply dummy text of the printing and
